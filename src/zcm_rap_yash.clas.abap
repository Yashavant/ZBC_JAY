CLASS zcm_rap_yash DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS: BEGIN OF date_interval,
                 msgid TYPE symsgid VALUE 'ZRAP_MSG_YASH',
               ...
               BEGIN OF customer_unkonwn,
                 ...
                 attr3 TYPE scx_attrname VALUE ' ',
                 attr4 TYPE scx_attrname VALUE ' ',
               END OF customer_unkonwn,

               BEGIN OF agency_unkonwn,
                 msgid TYPE symsgid VALUE 'ZRAP_MSG_YASH',
                 ...
                 attr3 TYPE scx_attrname VALUE ' ',
                 attr4 TYPE scx_attrname VALUE ' ',
               END OF agency_unkonwn,

               BEGIN OF unathorized,
                 msgid TYPE symsgid VALUE 'ZRAP_MSG_YASH',
...
CLASS zcm_rap_yash IMPLEMENTATION.
